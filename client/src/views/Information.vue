<template>
  <div class="information">
    <div class="action">
      <div class="action-item" @click="extractAllContentAudio()">Extract words</div>
...
export default {
  ...
  methods: {
    ...
    extractAllContentAudio() {
      for (let audio of this.audio_data){
        this.extractContentAudio(audio.id)
      }
    },
    getAudioList() {
      axios
